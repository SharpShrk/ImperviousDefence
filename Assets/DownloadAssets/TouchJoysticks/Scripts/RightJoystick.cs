...
public class RightJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    [SerializeField] private Image bgImage; // background of the joystick, this is the part of the joystick that recieves input
    [SerializeField] private Image joystickKnobImage; // the handle part of the joystick, it just moves to provide feedback, it does not receive input from the touch
